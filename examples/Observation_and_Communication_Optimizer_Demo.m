...
tic
[Swarm, goal, problem_solve_time] = observation_and_communication_optimizer(ErosGravity, Swarm, bandwidth_model, data_scaling_factor, observation_and_communication_optimizer_options);
toc
problem_solve_time
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
