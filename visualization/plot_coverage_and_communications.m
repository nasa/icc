...
% plot_coverage_and_communications A function to plot both coverage and communications.
% Syntax: [] = plot_coverage_and_communications(Swarm, ErosModel, absolute*, color_array*, record_video*, videoname*)
