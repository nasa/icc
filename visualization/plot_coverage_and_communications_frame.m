...
% Syntax: [view] = plot_coverage_and_communications_frame(Swarm, ErosModel, plot_time_index, figure_handle*, axes_limits*, color_array*, absolute*)
...
h_mem = plot_memory_use(swarm, time, ...
